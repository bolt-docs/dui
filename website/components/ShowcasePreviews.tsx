...
export function QrCodeDemo() {
	...
	// Real scannable QR matrix for "https://github.com/bolt-docs/dui"
	// Generated with the `qrcode` package (EC level M, margin 1 → 29×29).
	const qrData = [
		"███████░████░███░░░██░███████",
		"█░░░░░█░█░░███░░███░█░█░░░░░█",
		"█░███░█░░████░░░█░░██░█░███░█",
	...
	const lines = [
		...
		`  ${dim}https://github.com/bolt-docs/dui${reset}`,
		"",
		...rendered,
		"",
		`  ${dim}EC: M  |  margin: 1  |  scannable${reset}`,
	];
	...
	return (
		<TerminalPreview
			...
			screenClassName="min-h-[400px] flex flex-col justify-start"
		>
			{lines.join("\n")}
		</TerminalPreview>
	);
