...
|---------|-------------|---------------------|
| [@dui-toolkit/plugin-markdown](/docs/next/plugins/markdown) | Render markdown to ANSI-colored terminal output | `"md"` |
| [@dui-toolkit/plugin-diff](/docs/next/plugins/diff) | Unified and side-by-side diffs | `"diff"` |
| [@dui-toolkit/plugin-image](/docs/next/plugins/image) | Terminal image renderer (PNG, JPG, GIF) | `"image"` |
| [@dui-toolkit/plugin-qrcode](/docs/next/plugins/qrcode) | QR code generator | `"qrcode"` |
| [@dui-toolkit/plugin-chart](/docs/next/plugins/chart) | Bar, line, pie charts and sparklines | `"chart.bar"`, `"chart.line"`, `"chart.pie"`, `"chart.sparkline"` |
