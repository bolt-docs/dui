...
|---------|-------------|---------------------------|
| [@dui-toolkit/plugin-markdown](/docs/v0.6.0/es/plugins/markdown) | Renderiza markdown a terminal con colores ANSI | `"md"` |
| [@dui-toolkit/plugin-diff](/docs/v0.6.0/es/plugins/diff) | Diffs unificados y lado a lado | `"diff"` |
| [@dui-toolkit/plugin-image](/docs/v0.6.0/es/plugins/image) | Renderizador de imágenes en terminal (PNG, JPG, GIF) | `"image"` |
| [@dui-toolkit/plugin-qrcode](/docs/v0.6.0/es/plugins/qrcode) | Generador de códigos QR | `"qrcode"` |
| [@dui-toolkit/plugin-chart](/docs/v0.6.0/es/plugins/chart) | Gráficos de barras, líneas, pastel y sparklines | `"chart.bar"`, `"chart.line"`, `"chart.pie"`, `"chart.sparkline"` |
